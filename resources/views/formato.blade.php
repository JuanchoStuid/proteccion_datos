  ...
  <body>
    ...
    <header id="home" class="hero-area-2" data-stellar-background-ratio="0.5"> 
      ...
      <nav class="navbar navbar-expand-md fixed-top scrolling-navbar bg-transparent">
        {{-- <div class="container">
          <a class="navbar-brand" href="index.html"><span class="lni-bulb"></span>Datos</a>         
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-7 col-md-12 col-xs-12">
            <div class="show-box">
              <img src="{{ asset('/template/img/about/img1.png') }}" alt="">
            </div>
          </div>
        </div>
      </div>
        ...
        <div id="portfolio" class="row">
          <div class="col-lg-4 col-md-6 col-xs-12 mix development print">
            <div class="portfolio-item">
              <div class="shot-item">
                <img src="{{ asset('/template/img/portfolio/img-1.jpg') }}" alt="" />  
                <div class="single-content">
                  <div class="fancy-table">
                    <div class="table-cell">
                      <div class="zoom-icon">
                        <a class="lightbox" href="{{ asset('/template/img/portfolio/img-1.jpg') }}"><i class="lni-zoom-in item-icon"></i></a>
                      </div>
          ...
          <div class="col-lg-4 col-md-6 col-xs-12 mix design print">
            <div class="portfolio-item">
              <div class="shot-item">
                <img src="{{ asset('/template/img/portfolio/img-2.jpg') }}" alt="" /> 
                <div class="single-content">
                  <div class="fancy-table">
                    <div class="table-cell">
                      <div class="zoom-icon">
                        <a class="lightbox" href="{{ asset('/template/img/portfolio/img-2.jpg') }}"><i class="lni-zoom-in item-icon"></i></a>
                      </div>
                      <a href="#">View Project</a>
                    </div>
                  </div>
          ...
          <div class="col-lg-4 col-md-6 col-xs-12 mix development">
            <div class="portfolio-item">
              <div class="shot-item">
                <img src="{{ asset('/template/img/portfolio/img-3.jpg') }}" alt="" />  
                <div class="single-content">
                  <div class="fancy-table">
                    <div class="table-cell">
                      <div class="zoom-icon">
                        <a class="lightbox" href="{{ asset('/template/img/portfolio/img-3.jpg') }}"><i class="lni-zoom-in item-icon"></i></a>
                      </div>
                      <a href="#">View Project</a>
                    </div>
                  </div>
          ...
          <div class="col-lg-4 col-md-6 col-xs-12 mix development design">
            <div class="portfolio-item">
              <div class="shot-item">
                <img src="{{ asset('/template/img/portfolio/img-4.jpg') }}" alt="" /> 
                <div class="single-content">
                  <div class="fancy-table">
                    <div class="table-cell">
                      <div class="zoom-icon">
                        <a class="lightbox" href="{{ asset('/template/img/portfolio/img-4.jpg') }}"><i class="lni-zoom-in item-icon"></i></a>
                      </div>
                      <a href="#">View Project</a>
                    </div>
                  </div>
          ...
          <div class="col-lg-4 col-md-6 col-xs-12 mix development">
            <div class="portfolio-item">
              <div class="shot-item">
                <img src="{{ asset('/template/img/portfolio/img-5.jpg') }}" alt="" />  
                <div class="single-content">
                  <div class="fancy-table">
                    <div class="table-cell">
                      <div class="zoom-icon">
                        <a class="lightbox" href="{{ asset('/template/img/portfolio/img-5.jpg') }}"><i class="lni-zoom-in item-icon"></i></a>
                      </div>
                      <a href="#">View Project</a>
                    </div>
                  </div>
          ...
          <div class="col-lg-4 col-md-6 col-xs-12 mix print design">
            <div class="portfolio-item">
              <div class="shot-item">
                <img src="{{ asset('/template/img/portfolio/img-6.jpg') }}" alt="" />  
                <div class="single-content">
                  <div class="fancy-table">
                    <div class="table-cell">
                      <div class="zoom-icon">
                        <a class="lightbox" href="{{ asset('/template/img/portfolio/img-6.jpg') }}"><i class="lni-zoom-in item-icon"></i></a>
                      </div>
                      <a href="#">View Project</a>
                    </div>
                  </div>
            ...
            <div id="testimonials" class="touch-slider owl-carousel">
              <div class="item">
                <div class="testimonial-item">
                  <div class="author">
                    <div class="img-thumb">
                    <img src="{{ asset('/template/img/testimonial/img1.jpg') }}" alt="">
                    </div>
              ...
              <div class="item">
                <div class="testimonial-item">
                  <div class="author">
                    <div class="img-thumb">
                    <img src="{{ asset('/template/img/testimonial/img2.jpg') }}" alt="">
                    </div>
                    <div class="author-info">
              ...
              <div class="item">
                <div class="testimonial-item">
                  <div class="author">
                    <div class="img-thumb">
                    <img src="{{ asset('/template/img/testimonial/img3.jpg') }}" alt="">
                    </div>
                    <div class="author-info">
        ...
        <div class="row">
          <div class="col-lg-3 col-md-6 col-xs-12">
            <div class="single-team">
              <img src="{{ asset('/template/img/team/team1.png') }}" alt="">
          ...
          <div class="col-lg-3 col-md-6 col-xs-12">
            <div class="single-team">
              <img src="{{ asset('/template/img/team/team2.png') }}" alt="">
              <div class="team-details">
                <div class="team-inner">
          ...
          <div class="col-lg-3 col-md-6 col-xs-12">
            <div class="single-team">
              <img src="{{ asset('/template/img/team/team3.png') }}" alt="">
              <div class="team-details">
                <div class="team-inner">                  
          ...
          <div class="col-lg-3 col-md-6 col-xs-12">
            <div class="single-team">
              <img src="{{ asset('/template/img/team/team4.png') }}" alt="">
              <div class="team-details">
                <div class="team-inner">
          ...
          <div class="col-lg-4 col-md-6 col-xs-12 blog-item">
            ...
            <div class="blog-item-wrapper">
              ...
              <div class="blog-item-text"> 
                <div class="date"><i class="lni-calendar"></i>10 April, 2022</div>
      ...
      <div class="container">
        ...
        <div class="row" id="clients-scroller">
          <div class="client-item-wrapper">
            <img src="{{ asset('/template/img/clients/img1.png') }}" alt="">
          </div>
          <div class="client-item-wrapper">
            <img src="{{ asset('/template/img/clients/img2.png') }}" alt="">
          </div>
          <div class="client-item-wrapper">
            <img src="{{ asset('/template/img/clients/img3.png') }}" alt="">
          </div>
          <div class="client-item-wrapper">
            <img src="{{ asset('/template/img/clients/img4.png') }}" alt="">
          </div>
          <div class="client-item-wrapper">
            <img src="{{ asset('/template/img/clients/img5.png') }}" alt="">
          </div>
          <div class="client-item-wrapper">
            <img src="{{ asset('/template/img/clients/img6.png') }}" alt="">
          </div>
        </div>
      </div>
    </div> --}}
